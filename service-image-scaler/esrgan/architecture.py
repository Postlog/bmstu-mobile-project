...
class RRDBNet(nn.Module):
    ...
    def __init__(self, num_in_ch, num_out_ch, scale: int = 4, num_feat: int = 64, num_block: int = 23, num_grow_ch: int =32):
    ...
    def forward(self, x):
        ...
        # if self.scale == 8:
        #     feat = self.lrelu(self.conv_up3(F.interpolate(feat, scale_factor=[2.0], mode='nearest')))
